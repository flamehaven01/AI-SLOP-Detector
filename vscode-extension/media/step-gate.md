...
- **Run Self-Calibration** tunes the 4D weights to your codebase from your own
  run history. This is repository-local operational calibration, not an
  externally validated control.
...
across repositories. Every scan feeds the history that can make the next review
pass better tuned to that repository.
