...
JARGON_TERMS = [
    "neural", "quantum", "blockchain", "AI-powered", "deep-learning",
    "transformer", "Byzantine", "fault-tolerant", "state-of-the-art",
    "cutting-edge", "novel", "robust", "optimized", "scalable",
    "distributed", "microservice", "cloud-native", "serverless",
]
